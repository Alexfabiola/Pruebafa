...
use PruebaBundle\Entity\Inmueble;
...
class InmuebleController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $inmuebles = $em->getRepository('PruebaBundle:Inmueble')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('PruebaBundle\Form\InmuebleType', $inmueble);
    ...
    {
        $deleteForm = $this->createDeleteForm($inmueble);
        $editForm = $this->createForm('PruebaBundle\Form\InmuebleType', $inmueble);
