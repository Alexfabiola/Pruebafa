...
class PersonaController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $personas = $em->getRepository('PruebaBundle:Persona')->findAll();
    ...
    {
        $persona = new Persona();
        $form = $this->createForm('PruebaBundle\Form\PersonaType', $persona);
    ...
    {
        $deleteForm = $this->createDeleteForm($persona);
        $editForm = $this->createForm('PruebaBundle\Form\PersonaType', $persona);
